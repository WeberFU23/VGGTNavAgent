#!/usr/bin/env bash
# v29 正式批跑：10 ep（many/all，description；前 5 椅子后 5 混合），many/all 预算 300 步（benchmark 常量）。
set -u
PROJECT=/root/autodl-tmp/vggt_nav_agent
BENCH=/root/autodl-tmp/habitat_benchmark_eval_20260827
RUN_ROOT=/root/autodl-tmp/runs_formal10_v29_20260906
DATASET="$BENCH/benchmark_v6/semantic"
SCENE_ROOT=/root/autodl-tmp/datasets/hm3d/val
PORT=5555
EPS="4ok3usBNeis_ep0000010 CrMo8WxCyVb_ep0000002 5cdEh9F2hJL_ep0000010 BAbdmeyTvMZ_ep0000009 7MXmsvcQjpJ_ep0000014 q5QZSEeHe5g_ep0000010 a8BtkwhxdRV_ep0000006 cvZr5TUy5C5_ep0000002 a8BtkwhxdRV_ep0000001 QaLdnwvtxbs_ep0000016"
