#!/usr/bin/env bash
# 5-episode run: any/many/all from downloaded scenes (fresh episodes)
# any:  TEEsavR23oF_ep0000009
# many: k1cupFYWXJ6_ep0000003 (3x bench) / wcojb4TFT35_ep0000004 (2x bicycle)
# all:  TEEsavR23oF_ep0000001 (2x bathroom shelf) / wcojb4TFT35_ep0000001 (2x bench)
set -u

PROJECT=/root/autodl-tmp/vggt_nav_agent
BENCH=/root/autodl-tmp/habitat_benchmark_eval_20260827
RUN_ROOT=/root/autodl-tmp/runs_5ep_20260829
...
EPS="
TEEsavR23oF_ep0000009
k1cupFYWXJ6_ep0000003
TEEsavR23oF_ep0000001
wcojb4TFT35_ep0000004
wcojb4TFT35_ep0000001
