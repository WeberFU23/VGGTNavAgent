#!/usr/bin/env bash
# 补跑 2 个有效场景（hm3d/val 仅下载了 3 个场景）的新 episode：
# k1cupFYWXJ6_ep0000001 (any bench) / wcojb4TFT35_ep0000005 (any coffee machine)
# 与 run_5ep_20260830 同 RUN_ROOT，追加 eval，不复用 mapping server。
set -u
...
EPS="
k1cupFYWXJ6_ep0000001
wcojb4TFT35_ep0000005
...
for EP in $EPS; do
  ...
  screen -dmS nav-mapping-2ep bash -lc \
