#!/usr/bin/env bash
# 3-episode check run from downloaded scenes: any / many / all.
# any:  TEEsavR23oF_ep0000003
# many: k1cupFYWXJ6_ep0000002 (2x bench, v3 成功案例 -> 回归)
# all:  TEEsavR23oF_ep0000011  (4x wardrobe, v3 incomplete_finish -> 检查终止)
set -u

PROJECT=/root/autodl-tmp/vggt_nav_agent
BENCH=/root/autodl-tmp/habitat_benchmark_eval_20260827
RUN_ROOT=/root/autodl-tmp/runs_3ep_20260829_v2
